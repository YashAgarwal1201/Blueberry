<template>
  <nav class="w-full h-full p-1 grid grid-cols-4 md:flex md:flex-col justify-center gap-2">
...
import { Home, Menu, Search, UserCircle, Film, Tv } from 'lucide-vue-next'
...
const navLinks = computed(() => {
  ...
  links.push({ to: '/search', icon: Search, mobileHidden: false })
